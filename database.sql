...
INSERT INTO `bbms`.`blood_stocks` (`b_id`, `blood_group`, `unit`) VALUES ('2', 'B+', '2');
INSERT INTO `bbms`.`blood_stocks` (`b_id`, `blood_group`, `unit`) VALUES ('2', 'B1', '3');



INSERT INTO `bbms`.`user_health` (`user_id`, `userVitals`, `userHeight`, `userWeight`, `userStatus`) VALUES ('2', 'good', '165', '80', 'Good');
